...
void Aplication::aplicacion_admin() {
	...
	if (contrase.compare(contra) == 0) {
		...
		do {
			cout
					<< "  			*********   Bienvenido a la Administracion de la Aplicacion Wikilibros   ********\n\n"
					<< endl;
			cout
			...
			case 3: {
				cout << " Se ha creado el pedido de biblioteca nº: " << ++cpb
						<< endl;
		...
		cout << " Contrasenia introducida no válida. " << endl;
}
...
void Aplication::aplicacion_usuario() {
	...
	do {
		...
		case 1: {
			...
			if (var == false)
				cout << "El login o clave están ya en uso. " << endl;
			else {
