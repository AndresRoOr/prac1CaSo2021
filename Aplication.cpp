 ...
 */
Aplication::Aplication(const Aplication &apl) :
		bi(apl.bi), usu(apl.usu), lusu(apl.lusu), li(apl.li), pedBi(apl.pedBi), pedbi(
				apl.pedbi), pedusu(apl.pedusu), libro(apl.libro), pedbipunt(
				apl.pedbipunt) {
}
